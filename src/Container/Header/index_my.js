...
const Header = ( props ) => {
	...
	return (
		<header className="app-header navbar">
			...
			{props.logo && <img className="navbar-brand-full" src={props.logo} height="50" alt=" Logo" />}
			{props.logo && <img className="navbar-brand-minimized" src={props.logo} width="30" height="50" alt=" Logo" />}
			</a>
