						...
						<Card>
							...
							<Card.Body>
								...
								<Row>
									<Col sm={6}>
										<Form.Group controlId="referrerDomain">
											<Form.Control required name="packid" type="text" placeholder="PackId" onChange={e => this.setvalue(e)} value={this.state.packid} />
										</Form.Group>
									</Col>
								</Row>
								<Row>
								...
								<Row>
									<Col sm={6}>
										<Form.Group controlId="referrerDomain">
											<Form.Control required name="service" type="text" placeholder="Service Name" onChange={e => this.setvalue(e)} value={this.state.service} />
										</Form.Group>
									</Col>
								</Row>
